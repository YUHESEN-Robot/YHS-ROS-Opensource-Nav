...
int CameraSrv::start()
{
    ...
    ret = AS_SDK_StartListener(listener_callback, AS_LISTENNER_TYPE_USB, true);
//    ret = AS_SDK_StartListener(listener_callback, AS_LISTENNER_TYPE_NET, true);
    return ret;
}
...
void CameraSrv::onAttached(AS_CAM_ATTR_S *attr, void *privateData)
{
    ...
    CamSvrStreamParam_s stream_param = {
        ...
        .start = true,
        .image_flag = 0,
        // .image_flag = DEPTH_IMG_FLG | RGB_IMG_FLG | POINTCLOUD_IMG_FLG,
    };
