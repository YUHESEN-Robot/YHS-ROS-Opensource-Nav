...
bool publish_imu_data(receive_imusol_packet_t *data, sensor_msgs::Imu *imu_data, geometry_msgs::Vector3 &RPY_msg);
...
int main(int argc, char** argv)
{
	...
	ros::Publisher RPY_pub = n.advertise<geometry_msgs::Vector3>("rpy", 20);
