...
namespace can_control
{
  ...
  FrCanControl::FrCanControl()
  {
    ...
    cmd_sub_ = nh_.subscribe<geometry_msgs::Twist>("smoother_cmd_vel", 5, &FrCanControl::CmdCallBack, this);
  ...
  void FrCanControl::CmdCallBack(const geometry_msgs::Twist::ConstPtr &cmd_msg)
  {
